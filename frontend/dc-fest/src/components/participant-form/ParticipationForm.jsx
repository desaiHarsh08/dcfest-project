...
//             console.log("tmpSelectedCollege:", tmpSelectedCollege);
            ...
            <Card.Body className="d-flex flex-column" style={{ height: "700px" }}>
              ...
              <div className="form-scroll-container flex-grow-1">
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                  ...
                  <div className="d-flex flex-column justify-content-center">
                    <Button disabled={!isValid || loading} variant="primary" type="submit" size="lg">
                      {loading ? "Please wait..." : "Register"}
                    </Button>
                    {loading && <p>This may take a few seconds...</p>}
                  </div>
                </Form>
              </div>
            </Card.Body>
