...
public interface ParticipantRepository extends JpaRepository<ParticipantModel, Long> {
    ...
    List<ParticipantModel> findByEvent_IdAndCollegeId(@Param("eventId") Long eventId,
    ...
    List<ParticipantModel> findByEvent_IdAndCollegeIdAndGroup(@Param("eventId") Long eventId,
            @Param("collegeId") Long collegeId, @Param("group") String group);
